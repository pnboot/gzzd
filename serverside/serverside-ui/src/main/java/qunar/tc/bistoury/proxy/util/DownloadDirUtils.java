...
public class DownloadDirUtils {
    private static String defaultDownloadOtherStr = "/tmp/gzzd/";
    private static String defaultDownloadDumpStr = "/tmp/bistoury/qjtools/qjdump,/tmp/bistoury-class-dump";
