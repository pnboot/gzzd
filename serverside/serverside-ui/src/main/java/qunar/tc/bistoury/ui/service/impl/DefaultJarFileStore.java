...
import qunar.tc.bistoury.ui.config.UIConfig;
...
//        });
        ...
        mavenHost = UIConfig.configMap.get("maven.nexus.url");
        jarGuaranteePeriodDays = Integer.parseInt(UIConfig.configMap.getOrDefault(
